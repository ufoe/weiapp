	...
	<div class="nav-content">
		...
		<div class="right line-li">
			<ul>
				...
				<?php if($_SESSION[uid]==false): ?><li><a href="<?php echo U('Index/login');?>" class="hover">登录后台</a></li>
										...
										<TBODY>
											...
											<TR>
												<TD height="100" style="line-height:26px;">
													...
													<p>
														人工审核方法：客服QQQQ：<?php echo C('site_qq');?>，联系审核
													</p>
												</TD>
											</TR>
										</TBODY>
			...
			<div class="onlinebox-bottom-box">
				<div class="online-tbox">
					<div style="text-align: center; "><strong>在线时间</strong><br>	08:30-22:30<br>
						...
						<span style="font-weight: bold; ">服务热线<br>4000-000-000
	...
	<div class="footer-content clearfix">
		<div class="foot-menu">
			<p>
				...
				<a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo C('site_qq');?>&site=qq&menu=yes" target="_blank">业务定制</a>&nbsp;|&nbsp;
