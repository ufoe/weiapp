            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                ...
                <tr>
                  ...
                  <td><input type="text" required="" class="px" name="smsuser" value="<?php echo ($info["smsuser"]); ?>" tabindex="1" size="25"><span class="red">支持平台：<a href="http://cnrdn.com/a97C" target="_blank">点击注册</a><a href="http://jingyan.baidu.com/article/63f23628eb6b490209ab3d6b.html" target="_blank"><img src="<?php echo RES;?>/images/help.png" class="vm helpimg" title="帮助"></a></span>
                  </td>
                </tr>
				<tr>
